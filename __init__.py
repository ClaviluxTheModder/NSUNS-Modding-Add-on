...
###############   EVALUATED CODE
#######   NSUNS Modding Addon
class SNA_PT_Vilunder_Tools_35A0F(bpy.types.Panel):
    bl_label = "Vilunder Tools"
    bl_idname = "SNA_PT_Vilunder_Tools_35A0F"
    ...
    def draw_header(self, context):
        try:
            ...
            print(str(exc) + " | Error in Vilunder Tools panel header")
    ...
    def draw(self, context):
        try:
            ...
            op = layout.operator("object.remove_lod",text=r"Overwrite Mesh Properties",emboss=True,depress=False,icon_value=601)
            ...
            print(str(exc) + " | Error in Vilunder Tools panel")
...
def register():
    ...
    bpy.utils.register_class(SNA_PT_Vilunder_Tools_35A0F)
...
def unregister():
    ...
    bpy.utils.unregister_class(SNA_PT_Vilunder_Tools_35A0F)
